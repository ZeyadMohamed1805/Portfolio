...
const Contact = () => {
  ...
  const handleSubmit = (event: React.FormEvent<HTMLFormElement>) => {
    ...
    setLoading(true);
    emailjs.send("service_5dk0fcp", "template_w8yhvae", { from_name: form.name, to_name: "Zeyad Mohamed", form_email: form.email, to_email: "ZeyadMohamed.BUS.ACC@Gmail.com", message: form.message }, "TOVYufM1e839CPZJf")
    .then(() => {
      setLoading(false);
